<?php //netteCache[01]000409a:2:{s:4:"time";s:21:"0.31100400 1405511884";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:95:"/Applications/XAMPP/xamppfiles/htdocs/eshop/Blacklist/AdminModule/templates/Order/default.latte";i:2;i:1405511880;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:22:"released on 2014-03-17";}}}?><?php

// source file: /Applications/XAMPP/xamppfiles/htdocs/eshop/Blacklist/AdminModule/templates/Order/default.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, '5wnd176sew')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8a8386db9e_content')) { function _lb8a8386db9e_content($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="heading">Vyřízené objednávky</div>
<div class="abuttons">
<div class="abuttons">
...
<div class="abuttons">
<a class="abuttonson ajax" href="<?php echo htmlSpecialChars($_control->link("filterByDate!", array('done'))) ?>
">Datum</a>
<a class="ajax" href="<?php echo htmlSpecialChars($_control->link("filterByName!", array('done'))) ?>
">Jméno</a>
<a class="ajax" href="<?php echo htmlSpecialChars($_control->link("filterByProductCount!", array('done'))) ?>
">Počet položek</a>
<a class="ajax" href="<?php echo htmlSpecialChars($_control->link("filterByNoTrack!", array('done'))) ?>
">Neodesláno</a>
<a class="ajax" href="<?php echo htmlSpecialChars($_control->link("filterByPrice!", array('done'))) ?>
">Cena objednávky</a>
</div>
...
// block _orders
//
if (!function_exists($_l->blocks['_orders'][] = '_lb16fcc92ea5__orders')) { function _lb16fcc92ea5__orders($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('orders', FALSE)
?><table style="border:1px solid #aaa;width:100%" cellpadding="2" cellspacing="1" class="mytable">
<tr>
<td class="cen b" style="width:150px;">Kód</td>
...
<?php $iterations = 0; foreach ($orders as $order) { ?>
    <tr onmouseover="over(1,this)" onmouseout="over(0,this)">
        <td class="cen b" style="width:150px;" onclick="window.open(<?php echo htmlSpecialChars(Nette\Templating\Helpers::escapeJs($_control->link("Order:edit", array($order->id)))) ?>
...
<?php } ?>
        ...
        <td class="tdico" onclick="window.open(<?php echo htmlSpecialChars(Nette\Templating\Helpers::escapeJs($_control->link("Order:edit", array($order->id)))) ?>
)"><?php if ($order->senden == 1) { ?><img src="<?php echo htmlSpecialChars(Nette\Templating\Helpers::safeUrl($basePath)) ?>
...
.gif" alt="<?php echo htmlSpecialChars($order->language) ?>" title="<?php echo htmlSpecialChars($order->language) ?>"></td>
        <td align="center">
            <a class="hbtn ajaxs" href="<?php echo htmlSpecialChars($_control->link("changeStatus!", array('new', $order->id))) ?>
">
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb951d6f7ee1_head')) { function _lb951d6f7ee1_head($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
