<?php //netteCache[01]000412a:2:{s:4:"time";s:21:"0.05494200 1405334632";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:98:"/Applications/XAMPP/xamppfiles/htdocs/eshop/Blacklist/AdminModule/templates/Category/default.latte";i:2;i:1405333599;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:22:"released on 2014-03-17";}}}?><?php

// source file: /Applications/XAMPP/xamppfiles/htdocs/eshop/Blacklist/AdminModule/templates/Category/default.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'marhi5g67f')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3393e36791_content')) { function _lb3393e36791_content($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php $iterations = 0; foreach ($categories as $ctg) { ?>
			...
			<td>
			    <a href="#" target="_blank" title="Otevřít v novém okně"><?php echo Nette\Templating\Helpers::escapeHtml($ctg->link, ENT_NOQUOTES) ?></a>
                        ...
                        <td align="center"><?php echo Nette\Templating\Helpers::escapeHtml($template->date($ctg->createDate, 'F j, Y'), ENT_NOQUOTES) ?></td>
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lbade66db096_head')) { function _lbade66db096_head($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
